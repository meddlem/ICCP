program main
      ...
      real(8), parameter :: dt = 1.0, a = 1.0, rc = 5.0 ! defines: timestep, lattice constant (initial), potential cutoff length
      integer, parameter :: N=4000 !number of particles, multiple of 4
      real(8), parameter :: beta = 1.0, m = 1.0, L = 4.0 ! beta ~ 1/T, m = mass, L=length 
      ...
      call plw3d(1d0, 1d0, 1.2_plflt, 0d0, L, 0d0, L, 0d0, L, 20._plflt, 45._plflt)
...
subroutine plot_points(r,N)
        ...
        call plpoin3(r(:,1), r(:,2), r(:,3), 5) !this plots the points
        call plflush()
